...
#define BASE_FILE_UTIL base::fileutil
#define BEGIN_NAMESPACE_FILE_UTIL BEGIN_NAMESPACE(base) BEGIN_NAMESPACE(fileutil)
#define END_NAMESPACE_FILE_UTIL END_NAMESPACE() END_NAMESPACE()

#define BASE_HTTP_UTIL base::httputil
#define BEGIN_NAMESPACE_HTTP_UTIL BEGIN_NAMESPACE(base) BEGIN_NAMESPACE(httputil)
#define END_NAMESPACE_HTTP_UTIL END_NAMESPACE() END_NAMESPACE()
